...
Full technical write-up (C4 + sequence diagrams + decisions): **[ARCHITECTURE.md](ARCHITECTURE.md)**. What every node/tool/engine does: **[COMPONENTS.md](COMPONENTS.md)**. Interactive map: **`/graph`** (Cytoscape — click nodes, drag, zoom).
